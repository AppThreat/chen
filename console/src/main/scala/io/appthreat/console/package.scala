...
package object console:
    ...
    implicit class UnixUtils[A](content: Iterable[A]):
        ...
        /** Iterate over left hand side operand and write to file. Think of it as the Ocular version
        ...
        /** Iterate over left hand side operand and append to file. Think of it as the Ocular
    ...
    implicit class StringOps(value: String):
        ...
        /** Pipe string to file. Think of it as the Ocular version of the Unix `>` shell
          * redirection.
          */
        @deprecated("please use `#>` instead", "2.0.45 (August 2023)")
        def |>(outfile: String): Unit =
        ...
        /** Append string to file. Think of it as the Ocular version of the Unix `>>` shell
          * redirection.
          */
        @deprecated("please use `#>>` instead", "2.0.45 (August 2023)")
        def |>>(outfile: String): Unit =
