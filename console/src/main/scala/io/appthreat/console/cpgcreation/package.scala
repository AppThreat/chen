...
package object cpgcreation:
    ...
    /** Guess the main language for an entire directory (e.g. a whole project), based on a group
      * count of all individual files. Rationale: many projects contain files from different
      * languages, but most often one language is standing out in numbers.
      */
