...
import io.shiftleft.semanticcpg.language.dotextension.{
    AstNodeDot,
    CfgNodeDot,
...
/** Language for traversing the code property graph
  ...
  * using anything in the `steps` package, e.g. `Steps`
  */
package object language extends operatorextension.Implicits with LowPrioImplicits
    ...
    implicit def singleToControlStructureTrav[A <: ControlStructure](a: A)
      : ControlStructureTraversal =
        new ControlStructureTraversal(Iterator.single(a))
    implicit def iterOnceToControlStructureTrav[A <: ControlStructure](a: IterableOnce[A])
      : ControlStructureTraversal =
    ...
    implicit def iterOnceToIdentifierTrav[A <: Identifier](a: IterableOnce[A])
      : IdentifierTraversal =
    ...
    implicit def iterOnceToAnnotationTrav[A <: Annotation](a: IterableOnce[A])
      : AnnotationTraversal =
    ...
    implicit def toMember(traversal: IterableOnce[Member]): MemberTraversal =
        new MemberTraversal(traversal.iterator)
    implicit def toLocal(traversal: IterableOnce[Local]): LocalTraversal =
        new LocalTraversal(traversal.iterator)
    implicit def toMethod(traversal: IterableOnce[Method]): OriginalMethod =
        new OriginalMethod(traversal.iterator)

    implicit def singleToMethodParameterInTrav[A <: MethodParameterIn](a: A)
      : MethodParameterTraversal =
        new MethodParameterTraversal(Iterator.single(a))
    implicit def iterOnceToMethodParameterInTrav[A <: MethodParameterIn](a: IterableOnce[A])
      : MethodParameterTraversal =
        new MethodParameterTraversal(a.iterator)

    implicit def singleToMethodParameterOutTrav[A <: MethodParameterOut](a: A)
    ...
    implicit def iterOnceToMethodReturnTrav[A <: MethodReturn](a: IterableOnce[A])
    ...
    implicit def iterOnceToNamespaceBlockTrav[A <: NamespaceBlock](a: IterableOnce[A])
    ...
    implicit def iterOnceToMethodTravCallGraphExt[A <: Method](a: IterableOnce[A])
      : MethodTraversal =
    ...
    implicit def iterOnceToBindingMethodTrav[A <: Method](a: IterableOnce[A])
      : BindingMethodTraversal =
    ...
    implicit def iterOnceToBindingTypeDeclTrav[A <: TypeDecl](a: IterableOnce[A])
      : BindingTypeDeclTraversal =
    ...
    /** Warning: implicitly lifting `Node -> Traversal` opens a broad space with a lot of accidental
      * complexity and is considered a historical accident. We only keep it around because we want
      * to preserve `reachableBy(Node*)`, which unfortunately (due to type erasure) can't be an
      * overload of `reachableBy(Traversal*)`.
      *
      * In most places you should explicitly call `Iterator.single` instead of relying on this
      * implicit.
      */
    ...
    implicit def toNewNodeTrav[NodeType <: NewNode](trav: Iterator[NodeType])
      : NewNodeSteps[NodeType] =
    ...
    implicit def iterOnceToEvalTypeAccessorsLocal[A <: Local](a: IterableOnce[A])
      : EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](a.iterator)

    implicit def singleToEvalTypeAccessorsMember[A <: Member](a: A): EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](Iterator.single(a))
    implicit def iterOnceToEvalTypeAccessorsMember[A <: Member](a: IterableOnce[A])
      : EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](a.iterator)

    implicit def singleToEvalTypeAccessorsMethod[A <: Method](a: A): EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](Iterator.single(a))
    implicit def iterOnceToEvalTypeAccessorsMethod[A <: Method](a: IterableOnce[A])
      : EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](a.iterator)

    implicit def singleToEvalTypeAccessorsParameterIn[A <: MethodParameterIn](a: A)
      : EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](Iterator.single(a))
    ...
    implicit def singleToEvalTypeAccessorsParameterOut[A <: MethodParameterOut](a: A)
      : EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](Iterator.single(a))
    ...
    implicit def singleToEvalTypeAccessorsMethodReturn[A <: MethodReturn](a: A)
      : EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](Iterator.single(a))
    implicit def iterOnceToEvalTypeAccessorsMethodReturn[A <: MethodReturn](a: IterableOnce[A])
      : EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](a.iterator)

    implicit def singleToEvalTypeAccessorsExpression[A <: Expression](a: A): EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](Iterator.single(a))
    implicit def iterOnceToEvalTypeAccessorsExpression[A <: Expression](a: IterableOnce[A])
      : EvalTypeAccessors[A] =
        new EvalTypeAccessors[A](a.iterator)
    ...
    implicit def iterOnceToModifierAccessorsMember[A <: Member](a: IterableOnce[A])
      : ModifierAccessors[A] =
        new ModifierAccessors[A](a.iterator)

    implicit def singleToModifierAccessorsMethod[A <: Method](a: A): ModifierAccessors[A] =
        new ModifierAccessors[A](Iterator.single(a))
    implicit def iterOnceToModifierAccessorsMethod[A <: Method](a: IterableOnce[A])
      : ModifierAccessors[A] =
        new ModifierAccessors[A](a.iterator)

    implicit def singleToModifierAccessorsTypeDecl[A <: TypeDecl](a: A): ModifierAccessors[A] =
        new ModifierAccessors[A](Iterator.single(a))
    implicit def iterOnceToModifierAccessorsTypeDecl[A <: TypeDecl](a: IterableOnce[A])
      : ModifierAccessors[A] =
        new ModifierAccessors[A](a.iterator)
    // Modifier accessors ~
...
trait LowPrioImplicits extends overflowdb.traversal.Implicits:
    ...
    implicit def iterOnceToDeclarationNodeTraversal[A <: Declaration](a: IterableOnce[A])
      : DeclarationTraversal[A] =
