...
class TypeTraversal(val traversal: Iterator[Type]) extends AnyVal:
  ...
  def baseTypeTransitive: Iterator[Type] =
      traversal.repeat(_.baseType)(using _.emitAllButFirst.dedup)
  ...
  def derivedTypeTransitive: Iterator[Type] =
      traversal.repeat(_.derivedType)(using _.emitAllButFirst.dedup)
  ...
  def aliasTypeTransitive: Iterator[Type] =
      traversal.repeat(_.aliasType)(using _.emitAllButFirst.dedup)
