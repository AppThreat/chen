...
class ConditionalTests extends JavaSrcCode2CpgFixture:
  ...
  "should parse ternary expression" in {
      ...
      val List(condition: Call, thenExpr: Literal, elseExpr: Call) =
          ternaryExpr.argument.l: @unchecked
  ...
  "should find unresolved field-access args" in {
      ...
      val List(condition: Identifier, thenExpr: Call, elseExpr: Call) =
          conditional.argument.l: @unchecked
