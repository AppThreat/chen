...
import io.appthreat.javasrc2cpg.Config
  ...
  "types with java 17 exclusive features" ignore {
     ...
     |""".stripMargin
      ...
      "be resolved with a java 17 classloader" in {
          ...
          val expected =
              "javax.swing.filechooser.FileSystemView.getSystemIcon:javax.swing.Icon(java.io.File,int,int)"
      ...
      "be resolved by the system classloader (java 17)" in {
          ...
          cpg.call.name("getIconHeight").methodFullName.head.startsWith(
            "<unresolved"
          ) shouldBe false
      }
  }
