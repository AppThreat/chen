...
class AstCreator(
  ...
  packagesJarMappings: mutable.Map[String, mutable.Set[String]]
    ...
    /** Constructor and Method declarations share a lot of fields, so this method adds the fields
      * they have in common. `fullName` and `signature` are omitted
      */
    ...
    private def genericParamTypeMapForLambda(expectedType: ExpectedType)
    ...
    private def closureBindingsForCapturedNodes(lambdaMethodName: String)
