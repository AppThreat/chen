...
/** Unit tests for [[CDereference.dereferenceTypeFullName]].
  *
  * Covers raw pointer stripping and smart-pointer unwrapping using the CPG dot-separator convention
  * for namespaces (e.g. `std.shared_ptr<T>`).
  */
