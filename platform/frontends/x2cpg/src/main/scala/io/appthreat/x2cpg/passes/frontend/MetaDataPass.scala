...
/** A pass that creates a MetaData node, specifying that this is a CPG for language, and a
  * NamespaceBlock for anything that cannot be assigned to any other namespace.
  */
