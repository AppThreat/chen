...
object ListUtils:
  extension [T](list: List[T])
      /** Return each element in the list up to and including the first element which satisfies the
        * given predicate, or return the empty list if no matching element is found, e.g.
        *
