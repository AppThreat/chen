...
import io.appthreat.x2cpg.passes.controlflow.cfgcreation.Cfg.AlwaysEdge
import io.appthreat.x2cpg.passes.controlflow.cfgcreation.Cfg.FalseEdge
import io.appthreat.x2cpg.passes.controlflow.cfgcreation.Cfg.TrueEdge
...
class MixedCfgCreationPassTest extends CfgTestFixture(() => new JsCfgTestCpg()):
  ...
  "CFG generation for destructing assignment" should {
      ...
      "be correct for object destruction assignment with declaration and ternary init" in {
          ...
          succOf("_tmp_0.b") shouldBe expected(("b = _tmp_0.b", AlwaysEdge))
          succOf("b = _tmp_0.b") shouldBe expected(("_tmp_0", 3, AlwaysEdge))
          succOf("_tmp_0", 3) shouldBe expected((
      ...
      "be correct for object destruction assignment with reassignment and defaults" in {
          ...
          succOf("_tmp_0.a", 1) shouldBe expected((
            "_tmp_0.a === void 0 ? 1 : _tmp_0.a",
            AlwaysEdge
          ))
          ...
          succOf("_tmp_0.b", 1) shouldBe expected((
            "_tmp_0.b === void 0 ? 2 : _tmp_0.b",
            AlwaysEdge
          ))
      ...
      "be correct for nested object destruction assignment with defaults as parameter" in {
       ...
       |}""".stripMargin)
          ...
          succOf("param1_0", 1) shouldBe expected((
            "param1_0 === void 0 ? {} : param1_0",
            AlwaysEdge
          ))
          ...
          succOf("_tmp_1 = param1_0 === void 0 ? {} : param1_0") shouldBe expected((
            "id",
            AlwaysEdge
          ))
      ...
      "be correct for array destruction assignment with defaults" in {
          ...
          // true, false cases
          succOf("_tmp_0[0] === void 0") shouldBe expected(
            ("1", TrueEdge),
            ("_tmp_0", 2, FalseEdge)
          )
          ...
          // true, false cases
          succOf("_tmp_0[1] === void 0") shouldBe expected(
            ("2", TrueEdge),
            ("_tmp_0", 4, FalseEdge)
          )
