...
class Babel8ShapeAstCreationPassTest extends AbstractPassTest:
  ...
  //   src/test/resources/babel8/protobomLoader.js{,.json,.typemap}
  // generated by the Babel 8 astgen. Pins the real-world node shape so the
  ...
  //   src/test/resources/babel8-ts/HTTPError.ts{,.json,.typemap}
  // generated by the Babel 8 astgen. cdxgen ships no TypeScript, so this pins
  // the Babel 8 TS node shapes (generic class w/ default type param, `extends`,
