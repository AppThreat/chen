...
class ClassCpgTests extends PySrc2CpgFixture(withOssDataflow = false):
  ...
  "class with type parameters" should {
      "handle simple type parameter" in {
          ...
          typeDecl.fullName shouldBe "Test0.GenericClass"
          cpg.method.name("method").head.fullName shouldBe "Test0.GenericClass.method"
      ...
      "handle multiple type parameters" in {
          ...
          typeDecl.fullName shouldBe "Test0.MultiGeneric"
      ...
      "handle bound type parameter" in {
          ...
          typeDecl.fullName shouldBe "Test0.BoundedGeneric"
      ...
      "handle constrained type parameter (tuple syntax)" in {
          ...
          typeDecl.fullName shouldBe "Test0.ConstrainedGeneric"
      ...
      "handle ParamSpec" in {
          ...
          typeDecl.fullName shouldBe "Test0.CallableClass"
      }
      ...
      "handle TypeVarTuple" in {
          ...
          typeDecl.fullName shouldBe "Test0.VariadicClass"
      }
      ...
      "handle type parameter with default" in {
          ...
          typeDecl.fullName shouldBe "Test0.DefaultGeneric"
