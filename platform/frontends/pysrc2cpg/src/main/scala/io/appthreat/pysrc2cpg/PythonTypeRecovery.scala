...
private class RecoverForPythonFile(
  ...
  state: XTypeRecoveryState
    ...
    /** Determines if a function call is a constructor by following the heuristic that Python
      * classes are typically camel-case and start with an upper-case character.
      */
