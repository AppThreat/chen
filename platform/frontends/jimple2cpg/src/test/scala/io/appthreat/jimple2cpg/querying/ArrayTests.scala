...
class ArrayTests extends JimpleCode2CpgFixture:
  ...
  "should initialize array with three address code initialization expressions" in {
      ...
      val List(arrayInit: Call) =
          m.call.nameExact(Operators.alloc).code("new int\\[3\\]").l: @unchecked
      ...
      val List(stackAt0: Call, arg0: Literal) =
          m.assignment.code(".*\\[0\\] = 0").argument.l: @unchecked
      ...
      val List(stackAt1: Call, arg1: Literal) =
          m.assignment.code(".*\\[1\\] = 1").argument.l: @unchecked
      ...
      val List(stackAt2: Call, arg2: Literal) =
          m.assignment.code(".*\\[2\\] = 2").argument.l: @unchecked
