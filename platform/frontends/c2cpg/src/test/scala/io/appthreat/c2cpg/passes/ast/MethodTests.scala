...
class MethodTests extends CCodeToCpgSuite:
  ...
  "MethodTest2" should {
      ...
      "should identify method as stub" in {
          cpg.method.isStub.name.toSetMutable shouldBe Set(
  ...
  "MethodTest8" should {
      ...
      "be correct for all identifiers x, y in method3" in {
          ...
          val List(outerIdentifierX) =
              method.block.astChildren.astChildren.isIdentifier.nameExact("x").l
          ...
          val List(outerIdentifierY) =
              method.block.astChildren.astChildren.isIdentifier.nameExact("y").l
