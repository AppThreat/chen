...
class AstCreationPassTests extends AbstractPassTest:
  ...
  "Method AST layout" should {
      ...
      "be correct for decl assignment with identifier on the right" in
          ...
          |}""".stripMargin) { cpg =>
            ...
            inside(cpg.method("method").block.astChildren.assignment.source.l) {
      ...
      """.stripMargin) { cpg =>
        ...
        inside(cpg.method.name("method").ast.isCall.name(Operators.assignment).map(
  ...
  "Structural AST layout" should {
      ...
      "be correct for const_cast" in AstFixture(
        ...
        "file.cpp"
          ...
          cpg.call.name(Operators.cast).codeExact("const_cast<int>(n)").argument.code.l shouldBe List(
            "int",
            "n"
          )
      }
      ...
      "be correct for static_cast" in AstFixture(
        ...
        "file.cpp"
          ...
          cpg.call.name(Operators.cast).codeExact("static_cast<int>(n)").argument.code.l shouldBe List(
            "int",
            "n"
          )
      }
      ...
      "be correct for dynamic_cast" in AstFixture(
        ...
        "file.cpp"
          ...
          cpg.call.name(Operators.cast).codeExact("dynamic_cast<int>(n)").argument.code.l shouldBe List(
            "int",
            "n"
          )
      }
      ...
      "be correct for reinterpret_cast" in AstFixture(
        ...
        "file.cpp"
          ...
          cpg.call.name(Operators.cast).codeExact("reinterpret_cast<int>(n)").argument.code
              .l shouldBe List("int", "n")
      }
  ...
  "AST with types" should {
      ...
      "be correct for function edge case" in AstFixture(
        "class Foo { char (*(*x())[5])() }",
        "test.cpp"
      ) { cpg =>
