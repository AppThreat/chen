package io.appthreat.php2atom.utils

import io.appthreat.php2atom.astcreation.AstCreator.NameConstants
import io.appthreat.php2atom.utils.PhpScopeElement
import io.appthreat.x2cpg.Ast
import io.appthreat.x2cpg.datastructures.{Scope as X2CpgScope}
...
class Scope(implicit nextClosureName: () => String)
